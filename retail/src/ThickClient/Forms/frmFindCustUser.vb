...
Public Class frmFindCustUser

    Private FORMTITLE As String = "Find Customer"
    ...
    Private Sub frmFindCust_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With col1
            ...
            .DataPropertyName = DACustUser.PKID
        ...
        With col2
            .AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill
            .DataPropertyName = DACustUser.NAMEFIRST
        ...
        With col4
            .AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill
            .DataPropertyName = DACustUser.REFERENCE_NO
            .HeaderText = gGetLocale(Me.Name, "colIcNum.Text")
            .Name = "colIcNum"
            .ReadOnly = True
        End With

        Me.DataGridView1.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {col1, col2, col3, col4})
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Try
            Dim ds As DataSet
            ds = objDA.GetCustUser(txtSearch.Text)
            If ds Is Nothing OrElse ds.Tables.Count = 0 OrElse ds.Tables(0).Rows.Count = 0 Then
                Messenger.ShowInformation("Customer not found!")
                Exit Sub
            End If
            ...
            For Each dataCol As DataGridViewColumn In Me.DataGridView1.Columns
                If dataCol.DataPropertyName = DACustUser.PKID OrElse _
                    dataCol.DataPropertyName = DACustUser.NAMEFIRST OrElse _
                    dataCol.DataPropertyName = DACustUser.MOBILE_PHONE OrElse _
                    dataCol.DataPropertyName = DACustUser.REFERENCE_NO Then
