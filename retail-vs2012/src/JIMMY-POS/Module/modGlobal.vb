...
Module modGlobal
    ...
    Public Structure Permission
        ...
        Public Const GiveDiscount As String = "pos_perm_give_discount"
        Public Const OtherPayment As String = "pos_perm_other_payment"
        Public Const SaleHistory As String = "pos_perm_sale_history"
        Public Const Reset As String = "pos_perm_reset"
        Public Const Salesperson As String = "pos_perm_salesperson"
        Public Const FOC As String = "pos_perm_foc"
        Public Const GoodsExchange As String = "pos_perm_goods_exchange"
        Public Const CustAccount As String = "pos_perm_cust_account"
    ...
    Public Function gHasPermission(ByVal permission As String) As Boolean
        If gUserObj.username.ToUpper = "DEVELOPER" Then Return True
    ...
    Public Sub gSetLocaleChange(ByVal formName As String, ByVal ctl As Control)
        ...
        If ctl.GetType Is GetType(JimmyPos.MyDataGrid) Then
